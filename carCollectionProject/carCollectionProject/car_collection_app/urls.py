...
from carCollectionProject.car_collection_app.views import index, catalogue, profile_create, profile_details, \
    profile_edit, profile_delete, car_create, car_details, car_edit, car_delete
