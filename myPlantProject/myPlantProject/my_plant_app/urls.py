...
from myPlantProject.my_plant_app.views import index, catalogue, profile_create, profile_details, \
    profile_edit, profile_delete, plant_create, plant_details, plant_edit, plant_delete
