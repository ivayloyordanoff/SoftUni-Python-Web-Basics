...
from gamesPlayProject.games_play_app.views import index, dashboard, profile_create, profile_details, \
    profile_edit, profile_delete, game_create, game_details, game_edit, game_delete
